...
export declare class Sessions extends APIResource {
     ...
     */
    list(query?: SessionListParams, options?: Core.RequestOptions): Core.PagePromise<SessionListResponsesSessionsCursor, SessionListResponse>;
    list(options?: Core.RequestOptions): Core.PagePromise<SessionListResponsesSessionsCursor, SessionListResponse>;
    /**
...
export declare class SessionListResponsesSessionsCursor extends SessionsCursor<SessionListResponse> {
}
/**
